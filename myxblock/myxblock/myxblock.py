...
class MyXBlock(XBlock):
    """
    this my first xblock that can be used as voting for students just like the thumbs.py in thumbs directory
    in xblock-sdk
    """
    ...
    voted= False
    #Boolean(help="Has this student voted?", default=False, scope=Scope.user_state)
